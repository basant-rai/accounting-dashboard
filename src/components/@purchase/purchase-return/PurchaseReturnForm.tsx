          ...
          <div className='mt-4'>
            <div className='grid md:grid-cols-2 gap-8'>
              <div className='xl:w-1/2'>
                ...
                <div className='flex justify-center items-center space-x-2 py-10 mt-2 px-10 border border-primary-500 rounded-lg relative hover:cursor-pointer' onClick={() => setSelect(!select)}>
                  {
                    select ?
              ...
              <div className="grid xl:grid-cols-2 gap-4">
                <div className="">
                  <label className="mt-6 mb-2 ml-1 font-bold text-sm text-slate-700" >Debit Note Date
                ...
                <div className="">
                  <label className="mt-6 mb-2 ml-1 font-bold text-sm text-slate-700" >Debit Note Number
                    <span className='text-red-500'>*</span>
                    <input
                      type="date"
                      className="text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 placeholder:text-sm focus:border-fuchsia-300 focus:outline-none" />
