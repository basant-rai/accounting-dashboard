      ...
      <div className="mx-auto flex flex-col p-4 break-words bg-white border-0 h-auto opacity-100 visible rounded-xl ">
        <div className="flex flex-wrap items-center justify-between ">
          <div className='inline-flex items-center'>
            ...
            <div className="font-bold text-xl ml-2">Invoice: INV-00022</div>
          </div>
        ...
        <div className="mt-8">
          <p className="bg-primary-500 text-white py-4 px-2 rounded-lg">This is a DRAFT invoice and will be reflected to charts after it gets sent.</p>
          ...
          <ol className="relative border-l border-gray-200 mt-10 ml-5">
            ...
            <li className="mb-10 ml-8">
              ...
              <p className="mb-4 text-base font-normal text-gray-500">Status: Awaiting payment</p>
              <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 sm:items-center">
                <Button htmlType={'button'} type={'white'} >Mark sent</Button>
                <Button htmlType={'button'}>Add payment</Button>
              </div>
            </li>
          </ol>
